...
const Gift = () => {
    return <section className="pl-[10vw] pt-[4.5vw]">
        ...
        <div className="relative w-[81vw] h-[36.75vw] flex items-end">
            <svg className="absolute left-[8.5vw] top-[8vw]" xmlns="http://www.w3.org/2000/svg" width="161" height="102" viewBox="0 0 161 102" fill="none">
            ...
            <Image fileName="fiver-logo.jpg" className="rounded-md" />
