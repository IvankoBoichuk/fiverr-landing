const Timer = () => {
    return <div id="timer" className="mx-auto mt-[2vw] w-[88.5vw] font-codec sticky top-5 z-50 py-[3vw] pl-[4.75vw] pr-[6.75vw] text-[#FB8B28] border border-[#FB8B28] bg-[#111111] rounded-full flex items-center">
